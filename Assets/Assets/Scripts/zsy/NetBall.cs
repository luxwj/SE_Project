...
public  class NetBall : NetworkBehaviour
{
    ...
    /// Need to change
    /// </summary>
    protected NGameController gameController;
    ...
    protected virtual void InitBall()
    {
        ...
        gameController = GameObject.FindWithTag("GameController").GetComponent<NGameController>();
    }
    ...
    {
        NetPlayerBat hitPlayer = other.gameObject.GetComponent<NetPlayerBat>();
        if (hitPlayer.GetBatState() == (int)NetPlayerBat.BatState.none)
            return;
